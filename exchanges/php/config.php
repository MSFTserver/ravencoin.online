...
$conf['db_hostname'] = '50.62.177.183'; // MySQL host name
$conf['db_username'] = 'ravencoin'; // MySQL username
$conf['db_password'] = 'ravencoin123451'; // MySQL password
$conf['db_name'] = 'ravencoinmain'; // MySQL database name
...
$conf['logo_alt_text'] = 'Ravencoin';


// Colours
$conf['colour_background'] = 'url(https://www.wallpaperup.com/uploads/wallpapers/2014/09/23/454317/c840f822a479f9909afe88ebd4d4a7f0.jpg)';
$conf['colour_block_background'] = 'rgba(72, 19, 95, 0.5)';
$conf['colour_font'] = '#fff';
$conf['colour_progressbar'] = '#3297f9';
$conf['colour_progressbar_background'] = '#fff';
$conf['colour_progressbar_font'] = '#000000';
$conf['colour_icons'] = '#49d1e1';
$conf['colour_submit'] = '#225fae';
$conf['colour_hover'] = '#225fae';


// Website name
$conf['website_name'] = 'ravencoin.online'; // Name of the Website as it appear on page and emails
...
$conf['RVN'] = 'RTnH2fnNZGkr86Co5tiUxeMw9amFJf3y3e'; // Remove or leave empty if not used

// Google map
$conf['map_activated'] = FALSE;
$conf['map_api_key'] = 'AIzaSyDTDzwDA-1AhkuE7gB10Vp0fEyDDxW5RiU'; // API key from https://developers.google.com/maps/documentation/javascript/
...
$conf['email_address'] = 'admin@ravencoin.online'; // Email address sending all the emails messages
$conf['email_from_name'] = 'Admin at ravencoin.online'; // Email from


// About
$conf['about_activated'] = FALSE; // Show or hide the about page with TRUE or FALSE
...
// Admin access
$conf['admin_username'] = 'msftserver'; // Administrator username
$conf['admin_password'] = 'ravencoin123451'; // Administrator password
$conf['admin_cookie'] = 'RaVeNcOiNCoOkIe'; // Administrator cookie identification
